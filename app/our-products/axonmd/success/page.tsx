      ...
      <div className="bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-lg p-8 shadow-sm text-center">
            ...
            <p className="text-gray-700 mb-2">Your registration has been done successfully.</p>
            <p className="text-gray-600">You will receive onboarding steps by email shortly, Post verification your account will be activated immediately.</p>
