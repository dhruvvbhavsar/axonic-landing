        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover our cutting-edge artificial intelligence solutions that transform healthcare delivery, enhance patient care, and empower medical professionals with intelligent automation.
            </p>
          </div>
